export default {
  ...
  client: {
    ...
    assessment_form: {
      ...
      description: "Choose which of the following description most closely describes the client's situation, base on your observations.",
      specific: "what specific goal will the client be working toward over the next few months?",
    ...
    case_note_form: {
      ...
      type: 'Type',
      noted: "Note: Choose 'visit' only if you met with the client.",
  ...
  family: {
    ...
    select_contract_date: 'Please choose Contract Date',
