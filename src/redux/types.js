...
export const REFERRAL_SOURCE_CATEGORIE_TYPES = createConstants('REFERRAL_SOURCE_CATEGORIES_REQUESTING', 'REFERRAL_SOURCE_CATEGORIES_SUCCESS', 'REFERRAL_SOURCE_CATEGORIES_FAILED')
...
export const QUEUE_CUSTOM_FIELD_PEROPERTY_TYPES = createConstants('QUEUE_CUSTOM_FIELD_PEROPERTIES_REQUEST_SUCCESS', 'QUEUE_CUSTOM_FIELD_PEROPERTIES_UPDATED', 'QUEUE_CUSTOM_FIELD_PEROPERTIES_FAILED', 'QUEUE_CUSTOM_FIELD_PEROPERTIES_DELETED')

export const QUEUE_CLIENT_ENROLLMENT_TYPES = createConstants('QUEUE_CLIENT_ENROLLMENTS_REQUEST_SUCCESS', 'QUEUE_CLIENT_ENROLLMENTS_UPDATED', 'QUEUE_CLIENT_ENROLLMENTS_FAILED', 'QUEUE_CLIENT_ENROLLMENT_DELETED')

export const QUEUE_ASSESSMENT_TYPES = createConstants(
  'REMOVE_QUEUE_ASSESSMENT',
  'UPDATE_QUEUE_ASSESSMENT',
  'CREATE_QUEUE_ASSESSMENT',
)