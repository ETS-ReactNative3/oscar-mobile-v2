...
export const CLIENT_TYPES = createConstants('CLIENTS_REQUESTING', 'CLIENTS_REQUEST_SUCCESS', 'CLIENTS_REQUEST_FAILED')
...
export const PROGRAM_STREAM_TYPES = createConstants(
  'PROGRAM_STREAMS_REQUESTING',
  'PROGRAM_STREAMS_REQUEST_SUCCESS',
  'PROGRAM_STREAMS_REQUEST_FAILED'
)
