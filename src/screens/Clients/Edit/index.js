...
s
  ...
  render() {
    const { client } = this.state
    const { users, birthProvinces, provinces, donors, referralSources, communes, villages, agencies, districts, translations } = this.props
        ...
        <ScrollView style={styles.mainContainer}>
          <KeyboardAvoidingView style={styles.container}>
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.given_name}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.given_name}
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.family_name}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.family_name}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
                ref='family_name'
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.local_given_name}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.local_given_name}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.local_family_name}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.local_family_name}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.birth_province}</Text>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.donor}</Text>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.code}</Text>
              <TextInput
                autoCapitalize="sentences"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.kid_id}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.kid_id}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
                ref='kid_id'
                style={styles.input}
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.current_province}</Text>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.district}</Text>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.commune}</Text>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.village}</Text>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.street_number}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.street_number}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.house_number}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.house_number}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
                ref='house_number'
                style={styles.input}
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.profile}</Text>
              <Profile onChange={this.updateClientState} image={client.profile} editable />
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.what3words}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.what3words}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
                style={styles.input}
            ...
            <View style={styles.inputContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={[styles.label, {color: 'red'}]}>* </Text>
                <Text style={styles.label}>{languages.initial_referral_date}</Text>
              </View>
              <DatePicker
            ...
            <View style={styles.inputContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={[styles.label, {color: 'red'}]}>* </Text>
                <Text style={styles.label}>{languages.referral_source}</Text>
              </View>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.referral_phone}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.referral_phone}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
            ...
            <View style={styles.inputContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={[styles.label, {color: 'red'}]}>* </Text>
                <Text style={styles.label}>{languages.name_of_referee}</Text>
              </View>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.name_of_referee}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.live_with}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.live_with}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
                ref='who_live_with'
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.telephone_number}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.telephone_number}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.is_the_client_rated_for_id_poor}</Text>
              <SectionedMultiSelect
                items={poorIds}
                uniqueKey="id"
                modalWithSafeAreaView
            ...
            <View style={styles.inputContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={[styles.label, {color: 'red'}]}>* </Text>
                <Text style={styles.label}>{languages.received_by}</Text>
              </View>
              <SectionedMultiSelect
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.follow_up_by}</Text>
              <SectionedMultiSelect
                items={this.listUserItems(users)}
                uniqueKey="id"
                modalWithSafeAreaView
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.follow_up_date}</Text>
              <DatePicker
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.school_name}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.school_name}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
                style={styles.input}
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.school_grade}</Text>
              <SectionedMultiSelect
                items={schoolGrades}
                uniqueKey="id"
                modalWithSafeAreaView
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.main_school_contact}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.main_school_contact}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
                style={styles.input}
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.has_been_in_orphanage}</Text>
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.has_been_in_government_care}</Text>
              <View style={styles.row}>
                <CheckBox
                  title="Yes"
                  checkedIcon="dot-circle-o"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.relevant_referral_information}</Text>
              <TextInput
                autoCapitalize="sentences"
                placeholder={languages.relevant_referral_information}
                placeholderTextColor="#b7b3b3"
                returnKeyType="next"
            ...
            <View style={styles.inputContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={[styles.label, {color: 'red'}]}>* </Text>
                <Text style={styles.label}>{languages.case_worker}</Text>
              </View>
              <SectionedMultiSelect
                items={this.listUserItems(users)}
                uniqueKey="id"
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>{languages.agencies_involved}</Text>
              <SectionedMultiSelect
